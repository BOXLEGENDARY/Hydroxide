...
local web = true
local user = "BOXLEGENDARY" -- change if you're using a fork
local branch = "main"
local importCache = {}
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/BOXLEGENDARY/releases"))[1]
